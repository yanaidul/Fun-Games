...
public class OpeningAnimationSequence : MonoBehaviour
{
    ...
    public void OnStartAnimation()
    {
        ...
        _headerText.anchoredPosition += new Vector2(0, 80);
        _subHeaderText.anchoredPosition -= new Vector2(250, 0);
        _playButton.anchoredPosition = new Vector2(0, -100);
        _aboutButton.anchoredPosition = new Vector2(0, -100);
        _exitButton.anchoredPosition = new Vector2(0, -100);
